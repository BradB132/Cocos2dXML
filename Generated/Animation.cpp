...
bool Animation::setSequence(std::string newSequence)
{
	...
	return Animation_Base::setSequence(newSequence);
}

bool Animation::setStartListener(Cocos2dXMLEventListener newStartListener)
{
	stopListeningToEvent(startListener);
	listenForEvent(newStartListener, cocos2d::SEL_NoteHandler(&Animation::handleAnimateEvent));
	
	return Animation_Base::setStartListener(newStartListener);
}
